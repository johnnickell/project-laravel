...
final class FightServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->singleton(AsynchronousCommandBus::class, LaravelQueuedCommandBus::class);
        $this->app->singleton(AsynchronousEventDispatcher::class, LaravelQueuedEventDispatcher::class);
        ...
        $this->app->singleton(PrivatePublisher::class, LaravelPrivatePublisher::class);
