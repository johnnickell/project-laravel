...
final class FrameworkSupportReceiptTest extends TestCase
{
    public function test_the_committed_receipt_is_a_deterministic_passing_laravel_receipt(): void
    {
        ...
        self::assertSame(['package' => 'johnnickell/fight-common', 'version' => '1.2.0-dev', 'reference' => 'ce212af215d4ddf8d70f349b7a8c5e634dc9e539'], $receipt['candidate']);
        self::assertSame('laravel', $receipt['framework']['name']);
        self::assertSame('13.31.0', $receipt['framework']['version']);
        self::assertSame([
        ...
        self::assertSame('ce212af215d4ddf8d70f349b7a8c5e634dc9e539', $fightCommon[0]['source']['reference']);
